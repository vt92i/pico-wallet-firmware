...
#define BIP39_ENTROPY_SIZE (32)                       // Size of the entropy in bytes (256 bits)
#define BIP39_ENTROPY_BITS (BIP39_ENTROPY_SIZE * 8)   // Size of the entropy in bits
#define BIP39_SHA256_BITS  (BIP39_ENTROPY_BITS / 32)  // Size of the SHA-256 hash in bits
#define BIP39_FINAL_BIN_SIZE \
  (BIP39_ENTROPY_BITS + BIP39_SHA256_BITS)  // Size of the final binary representation (entropy + SHA-256)
#define BIP39_MAX_WORD_SIZE   (8)           // Maximum size of a word in the BIP39 wordlist (English)
#define BIP39_SEED_SIZE       (64)          // Size of the generated seed (512 bits)
